...
var handleGetAllRestaurants = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _restaurantService["default"].getAllRestaurants();
        case 3:
          data = _context.sent;
  ...
  return function handleGetAllRestaurants(_x, _x2) {
...
var handleCreateNewRestaurant = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res, io) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return _restaurantService["default"].createNewRestaurant(req.body);
        case 2:
          data = _context2.sent;
          if (data.status === 200) {
  ...
  return function handleCreateNewRestaurant(_x3, _x4, _x5) {
    return _ref2.apply(this, arguments);
  };
}();
var handleDeleteRestaurant = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res, io) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 2:
          _context3.next = 4;
          return _restaurantService["default"].deleteRestaurant(req.body.id);
        case 4:
          data = _context3.sent;
          if (data.status === 200) {
            io.sockets.emit("update-restaurant-data", "success");
  ...
  return function handleDeleteRestaurant(_x6, _x7, _x8) {
    return _ref3.apply(this, arguments);
  };
}();
var handleEditRestaurant = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res, io) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.next = 2;
          return _restaurantService["default"].updateRestaurantData(req.body);
        case 2:
          data = _context4.sent;
          if (data.status === 200) {
            io.sockets.emit("update-restaurant-data", "success");
  ...
  return function handleEditRestaurant(_x9, _x10, _x11) {
...
var handleGetDetailRestaurantById = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _context5.prev = 0;
          _context5.next = 3;
          return _restaurantService["default"].getDetailRestaurantById(req.query.id);
        case 3:
          data = _context5.sent;
  ...
  return function handleGetDetailRestaurantById(_x12, _x13) {
...
var handleGetRestaurantByLocation = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          _context6.prev = 0;
          _context6.next = 3;
          return _restaurantService["default"].getRestaurantByLocation(req.query.location);
        case 3:
          data = _context6.sent;
  ...
  return function handleGetRestaurantByLocation(_x14, _x15) {
